...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BrandedSlideDeck = __webpack_require__(172);

	var _BrandedSlideDeck2 = _interopRequireDefault(_BrandedSlideDeck);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = _BrandedSlideDeck2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BrandedSlideDeck = function (_Component) {
		_inherits(BrandedSlideDeck, _Component);

		function BrandedSlideDeck() {
			_classCallCheck(this, BrandedSlideDeck);

			var _this = _possibleConstructorReturn(this, (BrandedSlideDeck.__proto__ || Object.getPrototypeOf(BrandedSlideDeck)).call(this));
		...
		return BrandedSlideDeck;
	}(_react.Component);

	exports.default = BrandedSlideDeck;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slides = __webpack_require__(180);
	...
	var Slides = function (_Component) {
		...
		function Slides() {
			...
			_this.adjustContainerWidth = function () {
				var scale = _this.refs.slides.parentNode.clientWidth / 700;
				_this.setState({
					adjustContainerWidth: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cover = __webpack_require__(175);
		...
		_createClass(Cover, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ style: _cover2.default.section },
						_react2.default.createElement(
							'span',
							{ style: Object.assign({}, _cover2.default.span, _cover2.default.title) },
							title
						),
						_react2.default.createElement('span', { style: Object.assign({}, _cover2.default.span, _cover2.default.subtitle), dangerouslySetInnerHTML: { __html: subtitle } }),
						_react2.default.createElement(
							'span',
							{ style: Object.assign({}, _cover2.default.span, _cover2.default.copyright) },
							'© ',
							companyName,
							' ',
							...
							'This material and all course content is the proprietary intellectual property of ',
							companyName,
							'. and may only be used by course participants or educators for educational purposes as authorized by BrainStation. Any other use is unauthorized and unlawful.'
						)
					)
				);
			}
		...
		_createClass(Slide, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ style: _slide2.default.copyright },
						'© ',
						companyName,
						' ',
						new Date().getFullYear(),
	...
	var Column = function (_Component) {
		...
		_createClass(Column, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ style: Object.assign({}, _column2.default.column, columnWidth) },
					_react2.default.createElement(
						'div',
						{ style: _column2.default.vertiCenter },
						elems.map(function (elem, i) {

							if (elem.tag === 'span') {
								return _react2.default.createElement('span', {
									key: 'elem-' + i,
									style: Object.assign({}, _column2.default.span, _column2.default[elem.type]),
									dangerouslySetInnerHTML: { __html: elem.content } });
							} else if (elem.tag === 'img') {
								return _react2.default.createElement('img', {
									key: 'elem-' + i,
									style: _column2.default[elem.type],
									src: elem.content });
							}
						})
					)
...
/***/ function(module, exports) {
	...
	exports.default = {
		...
		quote: {
			...
			fontSize: 28,
			fontWeight: 300,
			borderLeft: '5px solid rgba(255,255,255,0.25)'
		},
		author: {
			width: 'calc(100% - 200px)',
			margin: '0 auto',
	...
	var Slides = function (_Component) {
		...
		_createClass(Slides, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ style: _controls2.default.mainContainer },
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							'span',
							{
								style: Object.assign({}, _controls2.default.span, _controls2.default.prevBtn),
								onClick: function onClick() {
						...
						_react2.default.createElement(
							'span',
							{ style: Object.assign({}, _controls2.default.span, _controls2.default.pagination) },
							currentSlide + 1,
							' / ',
							numberOfSlides
						),
						_react2.default.createElement(
							'span',
							{
								style: Object.assign({}, _controls2.default.span, _controls2.default.nextBtn),
								onClick: function onClick() {
									goToSlide(currentSlide + 1);
								} },
							'next'
